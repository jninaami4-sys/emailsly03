...
export const SERVICES: PriceService[] = [
  ...
  { ...SERVICE_CATALOG.warmup,         name: "Domain DNS Setup & Warmup", helper: "$40 per domain · DKIM/SPF/DMARC + 15-day warmup" },
  { ...SERVICE_CATALOG.mailbox_warmup, name: "Email Warmup",              helper: "$20 per mailbox · warm any inbox on same or different domains" },
