  ...
  return (
    <>
      ...
      <div className="sticky top-4 z-40 px-4">
        <nav
          aria-label="Primary"
          className="mx-auto flex h-12 max-w-6xl items-center justify-between rounded-full border border-white/50 bg-ink/35 px-5 shadow-[0_8px_32px_-12px_rgba(24,24,60,0.12)] backdrop-blur-2xl backdrop-saturate-[180%]"
        >
        ...
        {mobileOpen && (
          <div id="mobile-nav" className="mt-2 rounded-2xl border border-white/50 bg-ink/25 shadow-lg backdrop-blur-2xl backdrop-saturate-[180%] lg:hidden">
