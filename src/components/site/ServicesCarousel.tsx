...
const FALLBACK_SERVICES: Service[] = [
  ...
  },
  {
    ...
    tagline: "DKIM, SPF & DMARC + 15-day warmup — $40 per domain (typical: $80 / 2 domains).",
    badge: "Deliverability",
    price: "$80",
    perUnit: "$80 / 2 domains · from $40 / 1 domain",
    minOrder: "1 domain min",
    turnaround: "15 days",
    ...
    accent: "text-[#99f6e4]",
    Icon: PremiumShieldCheck,
    bullets: ["DKIM + SPF + DMARC", "Per-domain pricing", "Inbox placement"],
  },
  {
    serviceId: "mailbox_warmup",
    title: "Email Warmup",
    tagline: "Inbox warmup for individual mailboxes — add as many as you need, same or different domains.",
    badge: "Deliverability",
    price: "$20",
    perUnit: "per mailbox",
    minOrder: "1 mailbox min",
    turnaround: "15 days",
    gradient: "from-[#0f2547] via-[#2563eb] to-[#7fb0f5]",
    glow: "shadow-[0_40px_100px_-25px_rgba(37,99,235,0.6)]",
    ring: "ring-1 ring-inset ring-white/15",
    accent: "text-[#bfdbfe]",
    Icon: PremiumShieldCheck,
    bullets: ["Per-mailbox pricing", "Any domain", "15-day ramp"],
  },
  {
    serviceId: "webdesign",
