...
export function Header() {
  ...
  return (
    <>
      ...
      <div className="absolute -inset-1.5 -z-10 rounded-full bg-white/8 blur-2xl" aria-hidden="true" />
    </div>
    {mobileOpen && (
      <div id="mobile-nav" className="relative mt-2 overflow-hidden rounded-2xl border border-white/30 bg-white/35 shadow-[0_4px_24px_rgba(0,0,0,0.06),inset_0_0.5px_0_0_rgba(255,255,255,0.72),inset_0_-0.5px_0_0_rgba(0,0,0,0.05)] backdrop-blur-2xl backdrop-saturate-[180%] lg:hidden">
