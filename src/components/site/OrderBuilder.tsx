...
const SERVICES: Service[] = [
  ...
  { id: "manual", name: "Hand-Picked Leads", rate: 0.15, minQty: 100, minOrder: 15, unit: "lead", helper: "Min 100 leads · enter any quantity", icon: UserSearch, group: "data" },
  { id: "mobile", name: "Mobile Number Lookup", rate: 0.10, minQty: 100, minOrder: 10, unit: "record", helper: "Min 100 numbers · enter any quantity", icon: Phone, group: "growth" },
