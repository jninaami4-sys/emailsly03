...
/**
 * Adaptive-width nav bar with a "limelight" beam highlighting the active item.
 */
export const LimelightNav = ({
  ...
  return (
    <nav
      className={`relative inline-flex items-center h-16 rounded-lg bg-card border border-border ${className ?? ""}`}
    >
