...
-- =========================================================
-- Static store catalogue (mirrors src/lib/products.ts)
-- Ids match the frontend Product.id values so CartDrawer sends
-- matching product_id values. Safe to re-run.
-- =========================================================
