  ...
  return (
    <>
      ...
      <div className="sticky top-4 z-40 px-4">
        <nav
          aria-label="Primary"
          className="mx-auto flex h-12 max-w-6xl items-center justify-between rounded-full border border-white/40 bg-white/50 px-5 shadow-[0_8px_30px_-12px_rgba(24,24,60,0.18)] backdrop-blur-xl backdrop-saturate-150"
        >
