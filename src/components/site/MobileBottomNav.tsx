...
export function MobileBottomNav() {
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 flex justify-center px-4 pb-[calc(0.5rem+env(safe-area-inset-bottom))] pt-2">
      ...
      <button
        ...
        className="relative isolate flex w-auto max-w-[16rem] items-center justify-center gap-2 overflow-hidden rounded-full border border-white/15 bg-ink/95 px-4 py-1.5 text-xs font-semibold text-white shadow-[0_6px_24px_rgba(0,0,0,0.3),inset_0_1px_0_rgba(255,255,255,0.12),inset_0_-1px_0_rgba(0,0,0,0.25)] backdrop-blur-xl transition-all active:scale-[0.98] hover:bg-ink"
      >
        ...
        <span className="relative z-10 flex size-6 items-center justify-center rounded-full bg-white/10 ring-1 ring-white/15 backdrop-blur-sm">
