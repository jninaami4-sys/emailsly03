...
export const Route = createFileRoute("/privacy-policy")({
  ...
  component: () => (
    ...
    >
      ...
      <p>Business contact data we sell is sourced from publicly available records and third-party databases we license. Individuals can request removal at any time by emailing <a href="mailto:privacy@lyradata.com">privacy@lyradata.com</a>.</p>
      <h2>Your rights (GDPR / CCPA)</h2>
      <p>You may request access to, correction of, or deletion of your personal data at any time.</p>
      <h2>Contact</h2>
      <p>Questions? Email <a href="mailto:privacy@lyradata.com">privacy@lyradata.com</a>.</p>
    </LegalPage>
  ),
});
