  ...
  return (
    <>
      ...
      <aside
        ...
        className={`fixed inset-y-0 right-0 z-[90] flex w-full max-w-[720px] flex-col bg-background shadow-[0_0_80px_-10px_rgba(0,0,0,0.5)] transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] ${
